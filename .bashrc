...
alias xfreerdp3='nohup xfreerdp3 +async-channels +async-update +auto-reconnect /audio-mode:1 +clipboard +grab-keyboard +grab-mouse -themes +dynamic-resolution +prevent-session-lock /gdi:hw +gfx:AVC444:on /bpp:32 /size:1440x900 +kbd:layout:"Latin American",lang:0x240a'
